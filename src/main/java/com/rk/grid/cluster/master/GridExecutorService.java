...
import com.rk.grid.server.IInvocationService;
 ...
 *
 */
public class GridExecutorService extends AbstractExecutorService implements IInvocationService
{
     ...
     */
    public GridExecutorService(int brokerPort, List<String> jvmNodeParams, GridConfig gridConfig,  String serviceName) throws RemoteException
    {
		this.broker = new Broker<Object>(brokerPort,jvmNodeParams,gridConfig,serviceName);
		this.executionNamespace = gridConfig.getExecutionNamespace();
    }
	 ...
	 * @throws RemoteException 
     */
    public GridExecutorService(GridConfig gridConfig, List<String> jvmNodeParams) throws RemoteException
    {
    ...
    {
    	this.log("Starting local execution service of size="+this.getBroker().getClusterSize()+" for Broker "+this.getBroker().toString());
    ...
    {
	    return "RemoteExecutorService [broker=" + this.getBroker() + "]";
    }
